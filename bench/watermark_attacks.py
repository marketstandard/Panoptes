...
_SYNONYMS = {
    "said": "stated", "say": "suggest", "says": "suggests", "new": "recent",
    "more": "additional", "also": "likewise", "big": "large", "small": "little",
    "show": "demonstrate", "shows": "demonstrates", "find": "discover",
    "found": "discovered", "use": "utilize", "used": "utilized", "help": "assist",
    "make": "create", "made": "created", "get": "obtain", "need": "require",
    "important": "significant", "many": "numerous", "good": "beneficial",
    "bad": "harmful", "great": "excellent", "first": "initial", "last": "final",
    "long": "extended", "short": "brief", "high": "elevated", "low": "reduced",
    "old": "ancient", "young": "youthful", "people": "individuals",
    "city": "municipality", "team": "squad", "study": "investigation",
    "report": "account", "according": "per", "about": "regarding",
    "after": "following", "before": "preceding", "during": "throughout",
    "because": "since", "but": "however", "so": "therefore", "if": "provided",
    "when": "upon", "while": "whereas", "this": "the", "that": "which",
    "these": "those", "their": "its", "they": "these", "them": "those",
    "have": "possess", "has": "possesses", "will": "shall", "would": "might",
    "could": "might", "can": "may", "over": "throughout", "under": "beneath",
}
