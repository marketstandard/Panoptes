...
Usage:  python research/fetch_defactify.py
        python research/fetch_defactify.py --check   # verify local files only
"""
    ...
    payload = {
        ...
        "source": {
            ...
            "download_instructions": (
                "Run `python research/fetch_defactify.py`. The script downloads the three parquet splits "
